...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'> 
        <Title title='My Bookings' subTitle='Easily manage your past,current and upcoming hotel reservations in one place. Plan ypur trips seamlessly with just a few clicks'
        align='left'/>
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
          ...
          {bookings.map((booking)=>(
            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-gray-300  py-6 border-b first:border-t'>
              {/* Hotel Details */}
              ...
              {/* Date & Timings */}
              <div className='fleex flex-row md:items-center md:gap-12 mt-3 gap-8'>
                <div>
                  <p>Check-In:</p>
